...
class ActionChallengersActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listChallengeUser.add(ChallengeAnswer(5, "https://randomuser.me/api/portraits/men/51.jpg", "Kevin", "Bisous à la Tour Eiffel", null, Date(), 22, 62, 72,  7, "https://randomuser.me/api/portraits/thumb/men/33.jpg", 1))
        listChallengeUser.add(ChallengeAnswer(6, "https://randomuser.me/api/portraits/men/51.jpg", "Bruno", "Bisous à la Tour Eiffel", null, Date(), 22, 62, 72,  7, "https://randomuser.me/api/portraits/thumb/men/31.jpg", 1))
        listChallengeUser.add(ChallengeAnswer(7, "https://randomuser.me/api/portraits/men/51.jpg", "Nicolas", "Bisous à la Tour Eiffel", null, Date(), 22, 62, 72,  7, "https://randomuser.me/api/portraits/thumb/men/22.jpg", 1))
